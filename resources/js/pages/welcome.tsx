    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 not-has-[nav]:hidden w-full max-w-[335px] text-sm lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            ...
                            <>
                                <Link
                                    href={login()}
                                    className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-[#1b1b18] text-sm leading-normal hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                                >
                                    Log in
                                </Link>
                                {canRegister && (
                ...
                <div className="flex w-full items-center justify-center opacity-100 starting:opacity-0 transition-opacity duration-750 lg:grow">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-[#e3e3e0] before:border-l dark:before:border-[#3E3E3A]">
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-[#e3e3e0] before:border-l dark:before:border-[#3E3E3A]">
                                    <span className="relative bg-white py-1 dark:bg-[#161615]">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-black bg-[#1b1b18] px-5 py-1.5 text-sm text-white leading-normal hover:border-black hover:bg-black dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:hover:border-white dark:hover:bg-white"
                                        rel="noopener"
                                    >
                                        Deploy now
                                    </a>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            {/* Laravel Logo */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#F53003] opacity-100 starting:opacity-0 transition-all duration-750 motion-safe:starting:translate-y-6 dark:text-[#F61500]"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                aria-hidden="true"
                            ...
                            <svg
                                ...
                                aria-hidden="true"
                            >
                                <g className="text-[#1B1B18] opacity-100 starting:opacity-0 mix-blend-darken transition-all delay-300 duration-750 dark:text-black dark:mix-blend-normal">
                                    <mask
                                        id="path-1-mask"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 starting:opacity-0 transition-all delay-400 duration-750 motion-safe:starting:-translate-x-[26px] dark:text-[#4B0600]">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-[#F8B803] opacity-100 starting:opacity-0 mix-blend-color transition-all delay-400 duration-750 motion-safe:starting:-translate-x-[51px] dark:text-[#391800] dark:mix-blend-hard-light">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 starting:opacity-0 mix-blend-multiply transition-all delay-400 duration-750 motion-safe:starting:-translate-x-[78px] dark:text-[#733000] dark:mix-blend-normal">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 starting:opacity-0 mix-blend-hard-light transition-all delay-400 duration-750 motion-safe:starting:-translate-x-[102px] dark:text-[#4B0600]">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
