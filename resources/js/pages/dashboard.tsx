            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="px-1 py-4">
                    ...
                    <p className="mt-1 text-muted-foreground">
                        A full-screen, auto-advancing social media reader for
                        Mastodon and Bluesky. Connect your accounts, then open
                        the feed to watch posts cycle through with animated
                        text.
                    </p>
                </div>
