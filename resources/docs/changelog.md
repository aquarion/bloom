...
- **Richer link previews** — generic URL preview cards now show the linked page's description and preview image when the source platform provides one, alongside the existing title and favicon.
